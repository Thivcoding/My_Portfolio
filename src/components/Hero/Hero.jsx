  ...
  return (
    ...
    <div className='w-full h-auto lg:px-28 md:px-12  md:pt-[70px] pt-28 max-sm:px-6 bg-gradient-to-r from-indigo-900 to-indigo-950'>
        <div className='w-full lg:flex md:flex lg:h-[91vh] md:h-[600px] h-auto overflow-hidden'>
             <div className="lg:pe-10 lg:w-[55%] md:w-1/2 sm:w-full lg:flex md:flex sm:hidden lg:h-full md:h-full sm:h-1/2 flex-col justify-center uppercase font-sans lg:gap-8 md:gap-5" >
            <h1
              className="text-white flex lg:text-6xl md:text-4xl max-sm:text-3xl font-bold m-0 gap-4"
            ...
            <p
              className="text-white max-sm:my-4 " 
              data-aos-eseing="ease-in-out"
...
>
              <a href="#" className="uppercase">Getting Started</a>
          ...
          <div className="lg:w-[45%] md:w-1/2 sm:w-full flex-col  lg:h-full md:h-auto sm:h-1/2  md:py-14 max-sm:my-8 lg:pe-0 lg:p-10"
            >
                <div className="w-full h-[82%] flex items-end lg:gap-4 md:gap-5 max-sm:gap-5" >
                  <div  data-aos-eseing="ease-in-out" data-aos="zoom-in" className="lg:w-[88px] lg:h-[75px] md:w-[90px] md:h-[70px] max-sm:w-[70px] max-sm:h-[60px]  cursor-pointer p-2 border-2 border-sky-500 rounded-[10px]">
                        <img
                            src={ReactLogo}
                            alt="Profile"
                    ...
                    <div  className="w-full h-full hover:translate-y-2  transition-all duration-500 ease-in-out cursor-pointer lg:px-5">
                        <img
                            data-aos-eseing="ease-in-out" data-aos="zoom-in"
                            src={Profile}
                            alt="Profile"
                ...
                {/* icon */}
                <div  data-aos-eseing="ease-in-out" data-aos="zoom-in" className="w-full h-[18%] flex items-end justify-end lg:gap-10 md:gap-5 max-sm:gap-4 lg:mt-0 md:mt-2 max-sm:mt-6 lg:px-5">
                    {Image.map((item, index) => (
                      <div key={index}  className="lg:w-[75px] max-sm:-[60px] md:w-[70px] lg:h-[75px] max-sm:h-[60px] md:h-[70px]  cursor-pointer p-2 border-2 border-sky-500 rounded-[10px]" >
                        <img
                            src={item.image}
                            alt={item.alt}
